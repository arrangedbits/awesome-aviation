...
- [Safety & Accident Investigation](#safety--accident-investigation)
- [Medical / AME](#medical--ame)
- [Buying & Owning an Airplane](#buying--owning-an-airplane)
- [Drones / UAS](#drones--uas)
- [Career Paths](#career-paths)
- [Mobile Apps](#mobile-apps)
- [Communities](#communities)
- [Books (Non-Fiction)](#books-non-fiction)
- [Events & Airshows](#events--airshows)
...
* Depending on where you are there are a few options:
  * USA:
    * Start with a *Sport Pilot License* or *Private Pilot License*
  ...
  * Europe:
    * [EASA Flight Crew Licensing](https://www.easa.europa.eu/en/the-agency/faqs/flight-crew-licensing) - European Aviation Safety Agency pilot licensing info.
  * Canada:
    * [Transport Canada - Learn to Fly](https://tc.canada.ca/en/aviation/licensing-pilots-personnel/flight-crew-licensing) - Canadian pilot licensing requirements.
...
Weather is listed here as it's an important component of planning.  If this list grows, it can be expanded out.
...
## Personal Jets
Got some 💸? Dreamers read on - realists skip this.
...
## DIY Airplane
Think you can't afford to ever buy a plane? Then consider building one. 😉 It'll take time, but this is the ultimate experience in knowledge building and craftsmanship. This is for true aviation nuts with the time to spare (could take half a decade or so).
...
* ⭐[PiAware - ADS-B and MLAT Receiver ✈ FlightAware](https://flightaware.com/adsb/piaware/) - Use a [Raspberry Pi](https://en.wikipedia.org/wiki/Raspberry_Pi) to listen in for commercial airliner location, altitude and airspeed around you, and plot them on a nice web page.  Great weekend project for kids or adults alike.
...
* [Microsoft Flight Simulator 2024](https://www.flightsimulator.com/) - Stunning scenery, real-world weather, and career modes. The gold standard for consumer flight simulation.
...
* [BasicMed](https://www.faa.gov/licenses_certificates/airmen_certification/basic_med/) - Alternative to traditional FAA medical certification for GA pilots.
* [AOPA - Find an AME](https://www.aopa.org/go-fly/medical-resources/find-an-ame) - Aviation Medical Examiner locator.
* [AOPA Medical Resources](https://www.aopa.org/go-fly/medical-resources) - Guides on medical certification, special issuance, and conditions.

# Buying & Owning an Airplane
* [AOPA - Aircraft Ownership](https://www.aopa.org/go-fly/aircraft-and-ownership) - Comprehensive guide to buying and owning an airplane.
* [Savvy Aviation](https://www.savvyaviation.com/) - Aircraft maintenance management and pre-buy inspection services.
* [AOPA - Flying Clubs](https://www.aopa.org/go-fly/aircraft-and-ownership/flying-clubs) - Find or start a flying club to share ownership costs.
* [Vref Aircraft Value Reference](https://vfrguide.com/) - Aircraft valuation guide for buyers and sellers.

# Drones / UAS
* [FAA Part 107](https://www.faa.gov/uas/commercial_operators) - Commercial drone pilot certification and rules.
* [FAA Recreational Flyers](https://www.faa.gov/uas/recreational_flyers) - Rules and guidelines for flying drones recreationally.
* [B4UFLY App](https://www.faa.gov/uas/getting_started/b4ufly) - FAA's app to check airspace restrictions before flying a drone.
* [AUVSI](https://www.auvsi.org/) - Association for Uncrewed Vehicle Systems International.

# Career Paths
* [AOPA - Flight Training](https://www.aopa.org/training-and-safety) - Resources for every stage of pilot training.
* [CFI (Certified Flight Instructor)](https://www.faa.gov/pilots/become/flight_instructor) - The most common stepping stone to a professional flying career.
* [Regional Airline Association](https://www.raa.org/) - Information on regional airline careers and the pilot pipeline.
* [NBAA - Corporate Aviation Careers](https://www.nbaa.org/professional-development/careers/) - Business and corporate aviation career resources.

# Mobile Apps
* [CloudAhoy](https://www.cloudahoy.com/) - Flight debrief and analysis app. Replay your flights in 3D.
* [MyRadar](https://myradar.com/) - Fast, easy-to-use weather radar app useful for quick weather checks.
* [Garmin Pilot](https://fly.garmin.com/fly-garmin/garmin-pilot/) - Flight planning, navigation, and weather app from Garmin.

# Communities
* [EAA - Experimental Aircraft Association](https://www.eaa.org/) - Builders, restorers, and recreational flyers community. Home of AirVenture Oshkosh.
* [Beechtalk](https://www.beechtalk.com/) - Popular forum for Beechcraft owners and enthusiasts.
* [Pilots of America](https://www.pilotsofamerica.com/) - General aviation forum and community.

# Books (Non-Fiction)
* [Stick and Rudder](https://www.amazon.com/Stick-Rudder-Explanation-Art-Flying/dp/0070362408) by Wolfgang Langewiesche - The classic book on the art of flying. First published in 1944 and still essential.
* [Fate is the Hunter](https://www.amazon.com/Fate-Hunter-Ernest-K-Gann/dp/0671636030) by Ernest K. Gann - A memoir of early commercial aviation that reads like a thriller.
* [Weather Flying](https://www.amazon.com/Weather-Flying-Fifth-Robert-Buck/dp/0071799729) by Robert N. Buck - The definitive guide to understanding weather as a pilot.

# Events & Airshows
* [EAA AirVenture Oshkosh](https://www.eaa.org/airventure) - The world's largest aviation gathering. Held annually in Oshkosh, Wisconsin.
* [Sun 'n Fun Aerospace Expo](https://www.flysnf.org/) - Major annual fly-in and aviation expo in Lakeland, Florida.
...
* [The Finer Points](https://www.learnthefinerpoints.com/) - GA flight training podcast focused on proficiency and decision-making.
* [Opposing Bases](https://www.opposingbases.com/) - Stories from pilots and air traffic controllers.
...
* [Mentour Pilot](https://www.youtube.com/@MentourPilot) - Airline pilot breaking down incidents, procedures, and how aviation works.
* [74 Gear](https://www.youtube.com/@74gear) - 747 pilot sharing behind-the-scenes airline life and aviation knowledge.
* [blancolirio](https://www.youtube.com/@blancolirio) - Juan Browne's detailed aviation accident analysis and investigation coverage.
* [FlightChops](https://www.youtube.com/@FlightChops) - General aviation adventures from a passionate GA pilot.

## Newsletters
* [AOPA Aviation eBrief](https://www2.smartbrief.com/signupSystem/subscribe.action?pageSequence=1&briefName=aopa) - Daily aviation newsletter.

# Inspiration
* Think you're too old to learn to fly? Think again. People earn their pilot certificates at every age.
* [One Six Right](https://www.onesixright.com/) - A beautiful documentary about the history and romance of a small airport (Van Nuys).

# Aviation acronyms
A list of acronyms that are used here:
* GA - General Aviation. Essentially flying for fun.
* AGL - Above Ground Level
* VFR - Visual Flight Rules. Flying by visual reference to the ground and horizon.
...
* All the pilots, flight crews, ground and airport staff who fly us all safely from one place to another.  You've made aviation an everyday service that we've gotten so used to that if you're a bit off, we complain. So thanks for putting up with us.
...
We are providing the resources in this repository under an open source license. Because this is a personal, non-corporate repository, the license you receive is from this user, and not their employers.
